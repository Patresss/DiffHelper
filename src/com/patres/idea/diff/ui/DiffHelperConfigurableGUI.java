...
public class DiffHelperConfigurableGUI {
	...
	public void createUI(Project project) {
		...
		prepareFieldWithBrowseButton(project);
		preparePanesBorder();
	}

	private void preparePanesBorder() {
		taskNamePane.setBorder(IdeBorderFactory.createTitledBorder(DiffHelperBundle.message("action.border.taskName")));
		usernamePane.setBorder(IdeBorderFactory.createTitledBorder(DiffHelperBundle.message("action.border.userName")));
		diffPane.setBorder(IdeBorderFactory.createTitledBorder(DiffHelperBundle.message("action.border.diffTemplate")));
	}

	private void prepareFieldWithBrowseButton(Project project) {
		FileChooserDescriptor descriptor = FileChooserDescriptorFactory.createSingleFileDescriptor("sql");
		fieldWithBrowseButton.addBrowseFolderListener(DiffHelperBundle.message("action.diff.template.choose"), DiffHelperBundle.message("action.chooseFile"), project, descriptor);
	}
	...
	public boolean isModified() {
		...
		modified |= !fieldWithBrowseButton.getText().equals(diffHelperConfig.getDiffTemplatePath());
		return modified;
	}
	...
	public void apply() {
		...
		diffHelperConfig.setDiffTemplatePath(fieldWithBrowseButton.getText());
		if (nickNameFromGitCheckBox.isSelected()) {
	...
	public void reset() {
		...
		fieldWithBrowseButton.setText(diffHelperConfig.getDiffTemplatePath());
	}
